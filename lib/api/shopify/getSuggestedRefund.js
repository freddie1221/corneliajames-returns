...
export default async function getSuggestedRefund(returnData) {
  ...
  const refundOutstanding = parseFloat(response.data.return.suggestedRefund.amount.presentmentMoney.amount)
  ...
  return { refundOutstanding, returnValue, returnFullPrice }
